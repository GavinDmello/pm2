...
ReverseInteractor.prototype.stop = function () {
  ...
  this.transport.removeAllListeners('trigger:actio');
...
ReverseInteractor.prototype.start = function () {
  ...
  this.transport.on('trigger:pm2:scoped:action', this._onPM2Action.bind(this));
  this.transport.on('trigger:pm2:action', this._onPM2ScopedAction.bind(this));
};
